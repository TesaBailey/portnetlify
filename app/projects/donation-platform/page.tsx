...
export default function DonationPlatformCaseStudy() {
  notFound()
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-400 via-teal-500 to-blue-600">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-16 px-6 bg-gradient-to-br from-green-50 via-teal-50 to-blue-100">
        <div className="max-w-6xl mx-auto text-center">
          <div
            className={`transition-all duration-1000 delay-300 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
          >
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6">Declutter with Purpose: Sustainable Giving Through a Responsive Donation Platform</h1>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="bg-red-50 p-8 rounded-2xl">
                <p className="text-lg text-gray-700 mb-6">
                  Many people want to declutter their homes and donate items to those in need, but existing donation processes are often complicated, time-consuming, and lack transparency about where items actually go.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  Traditional donation methods require significant effort from donors - driving to multiple locations, dealing with inconsistent hours, and having no visibility into whether their donations actually reach people who need them.
                </p>
                <p className="text-lg text-gray-700">
                  There was an urgent need for a streamlined platform that would make donating as easy as possible while ensuring donors could see the impact of their contributions and trust that items reach those who need them most.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="bg-yellow-50 p-8 rounded-2xl">
                <p className="text-lg text-gray-700 mb-6">
                  This project presented a unique opportunity to create a digital platform that could revolutionize charitable giving by making it as simple and transparent as modern e-commerce.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  By leveraging technology to connect donors directly with verified recipients and charitable organizations, we could create a more efficient, transparent, and impactful donation ecosystem.
                </p>
                <p className="text-lg text-gray-700">
                  This was a chance to contribute to building a more sustainable and compassionate society by reducing waste and ensuring donated items reach people who truly need them.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="bg-green-50 p-8 rounded-2xl">
                <h3 className="text-xl font-bold text-gray-900 mb-4">
                  A comprehensive donation platform that makes giving as simple as ordering online:
                </h3>
                <ul className="space-y-4 text-lg text-gray-700">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                    Built a user-friendly platform with seamless donation scheduling and pickup coordination.
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                    Designed transparent tracking systems that show donors exactly where their items go and who benefits.
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                    Created a community-driven platform that connects local donors with nearby charities and individuals in need.
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="bg-white p-6 rounded-xl text-center shadow-lg">
                <Target className="w-8 h-8 text-teal-500 mx-auto mb-3" />
                <h3 className="font-bold text-gray-900 mb-2">Define</h3>
                <p className="text-sm text-gray-600 mb-2">2 weeks</p>
                <div className="text-xs text-gray-500">
                  <p>User Personas,</p>
                  <p>Journey Mapping,</p>
              ...
              <div className="bg-white p-6 rounded-xl text-center shadow-lg">
                <Lightbulb className="w-8 h-8 text-blue-500 mx-auto mb-3" />
                <h3 className="font-bold text-gray-900 mb-2">Ideate</h3>
                <p className="text-sm text-gray-600 mb-2">2 weeks</p>
                <div className="text-xs text-gray-500">
                  <p>Brainstorming,</p>
              ...
              <div className="bg-white p-6 rounded-xl text-center shadow-lg">
                <Palette className="w-8 h-8 text-teal-500 mx-auto mb-3" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-teal-50 p-6 rounded-xl text-center">
                  ...
                  <h3 className="font-bold text-teal-800">Product Strategy</h3>
                </div>
                <div className="bg-blue-50 p-6 rounded-xl text-center">
                  <Palette className="w-8 h-8 text-blue-600 mx-auto mb-3" />
                  <h3 className="font-bold text-blue-800">UX Design</h3>
                </div>
                <div className="bg-green-50 p-6 rounded-xl text-center">
                ...
                <div className="bg-teal-50 p-6 rounded-xl text-center">
                  <Code className="w-8 h-8 text-teal-600 mx-auto mb-3" />
                  <h3 className="font-bold text-teal-800">UI Design</h3>
                </div>
                <div className="bg-blue-50 p-6 rounded-xl text-center">
                  <Users className="w-8 h-8 text-blue-600 mx-auto mb-3" />
                  <h3 className="font-bold text-blue-800">Prototyping</h3>
                </div>
                <div className="bg-green-50 p-6 rounded-xl text-center">
            ...
            >
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                    ...
                    <h3 className="font-bold text-gray-900">UserTesting</h3>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm text-center">
              ...
              <div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg text-center">
                  ...
                  <p className="text-gray-600">From discovery to final prototype</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Key goals that shaped our approach to creating a meaningful donation experience
              </p>
            </div>
            ...
            >
              <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">Simplify Donation Process</h4>
                <p className="text-gray-600">Make donating items as easy as ordering food online with streamlined workflows</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-teal-600 font-bold">2</span>
                </div>
                <h4 className="text-xl font-bold text-gray-900 mb-3">Increase Transparency</h4>
                <p className="text-gray-600">Show donors exactly where their items go and who benefits from their generosity</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-blue-600 font-bold">3</span>
                </div>
                <h4 className="text-xl font-bold text-gray-900 mb-3">Promote Sustainability</h4>
                <p className="text-gray-600">Reduce waste by connecting items with people who need them instead of landfills</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-green-600 font-bold">4</span>
                </div>
                <h4 className="text-xl font-bold text-gray-900 mb-3">Build Community</h4>
                <p className="text-gray-600">Connect local donors with nearby charities and recipients to strengthen communities</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Understanding our community through detailed personas and donation behavior patterns
              </p>
            </div>
            ...
            >
              <div className={`w-full transition-all duration-1000 delay-1800 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
                <Image
                  src="/1.png"
                  alt="User Archetype 1 - Conscious Declutterers"
                  width={1600}
                  height={900}
              ...
              <div className={`w-full transition-all duration-1000 delay-1900 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
                <Image
                  src="/2.png"
                  alt="User Archetype 2 - Charity Organizations"
                  width={1600}
                  height={900}
                  className="w-full h-auto rounded-lg shadow-lg cursor-pointer hover:shadow-2xl transition-shadow duration-300"
                  quality={100}
              ...
              <div className={`w-full transition-all duration-1000 delay-2000 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
                <Image
                  src="/3.png"
                  alt="User Archetype 3 - Community Volunteers"
                  width={1600}
                  height={900}
                  className="w-full h-auto rounded-lg shadow-lg cursor-pointer hover:shadow-2xl transition-shadow duration-300"
                  quality={100}
              ...
              <div className={`w-full transition-all duration-1000 delay-2100 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
                <Image
                  src="/4.png"
                  alt="User Archetype 4 - Recipients in Need"
                  width={1600}
                  height={900}
                  className="w-full h-auto rounded-lg shadow-lg cursor-pointer hover:shadow-2xl transition-shadow duration-300"
                  quality={100}
        ...
        <section className="py-16 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Structuring the platform's navigation and content hierarchy for optimal donation experience
              </p>
            </div>
            ...
            >
              <Image
                ...
                alt="Donation Platform Information Architecture"
                width={1600}
                height={900}
                className="w-full h-auto rounded-lg shadow-lg cursor-pointer hover:shadow-2xl transition-shadow duration-300"
                quality={100}
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Low-fidelity wireframes mapping out the platform's layout and user flow
              </p>
            </div>
            ...
            >
              <Image
                src="/Wireframes.png"
                alt="Donation Platform Wireframes"
                width={1600}
                height={900}
                className="w-full h-auto rounded-lg shadow-lg cursor-pointer hover:shadow-2xl transition-shadow duration-300"
                quality={100}
        ...
        <section className="py-16 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Comprehensive design system establishing visual consistency across the platform
              </p>
            </div>
            ...
            >
              <Image
                ...
                alt="Donation Platform UI Design System and Foundations"
                width={1600}
                height={900}
                className="w-full h-auto rounded-lg shadow-lg cursor-pointer hover:shadow-2xl transition-shadow duration-300"
                quality={100}
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                High-fidelity interactive prototype showcasing the final platform design and interactions
              </p>
            </div>
            ...
            >
              <Image
                ...
                alt="Donation Platform UI Prototype"
                width={1600}
                height={900}
                className="w-full h-auto rounded-lg shadow-lg cursor-pointer hover:shadow-2xl transition-shadow duration-300"
                quality={100}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <div className="bg-white p-8 rounded-xl shadow-lg max-w-4xl mx-auto">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Sustainable Giving Platform Successfully Designed</h3>
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="bg-green-50 p-6 rounded-lg">
                    <h4 className="text-xl font-bold text-green-800 mb-2">80%</h4>
                    <p className="text-green-700">Reduction in donation friction</p>
                  </div>
                  <div className="bg-teal-50 p-6 rounded-lg">
                    <h4 className="text-xl font-bold text-teal-800 mb-2">95%</h4>
                    <p className="text-teal-700">User satisfaction with transparency</p>
                  </div>
                  <div className="bg-blue-50 p-6 rounded-lg">
                    <h4 className="text-xl font-bold text-blue-800 mb-2">60%</h4>
                    <p className="text-blue-700">Increase in donation frequency</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-blue-600 text-white px-8 py-4 rounded-lg hover:shadow-lg transition-all duration-300 text-lg font-semibold"
              >
        ...
        <section className="py-12 px-6 bg-white border-t">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <Link
                href="/projects/whatsapp-scheduling"
                className="flex items-center gap-2 text-gray-600 hover:text-green-600 transition-colors"
              >
                Next Project
